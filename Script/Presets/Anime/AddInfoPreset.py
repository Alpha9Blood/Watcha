...
class AddInfo:
    ...
    def AddAnime(self):
        ...
        #MaxEp
        self.Gui.Text.CreateLabel("MaxEp", 100, 2)
        ...
        self.Gui.Presets.CreateTooltip(self.Gui.LabelList[self.AnimeIndex.AddAnime.TextIndex.Status], "Can be Watching, Completed, Dropped, or PlanToWatch.")
        #Season
        ...
        #Serie
        self.Gui.Text.CreateLabel("Serie", 100, 5)
        self.AnimeIndex.AddAnime.TextIndex.Serie = self.Gui.Presets.UpdateTextIndex()
        self.Gui.Presets.CreateTooltip(self.Gui.LabelList[self.AnimeIndex.AddAnime.TextIndex.Serie], "Is optional.")
    ...
    def SetMyAnimeListLink(self):
        ...
        self.Gui.Text.CreateLabel("Name", 100, 1, 320)
        ...
        self.Gui.LabelList[self.AnimeIndex.SetMyAnimeListLink.TextIndex.Link].config(width=16, font=('Arial', 13))
    ...
    def SetWatchLink(self):
        ...
        self.Gui.Text.CreateLabel("Name", 100, 1, 510)
    ...
    def AddToCalendar(self):
        ...
        self.Gui.Text.CreateLabel("Name", 600, 1, 550)
        ...
        self.Gui.Text.CreateLabel("Day", 600, 2)
        self.AnimeIndex.AddToCallendar.TextIndex.Day = self.Gui.Presets.UpdateTextIndex()
        
        self.Gui.Presets.CreateTooltip(self.Gui.LabelList[self.AnimeIndex.AddToCallendar.TextIndex.Day], "Can be one of the following: Monday, Tuesday, Wednesday, Thursday, Friday, Saturday and Sunday.")
